  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage:
            "url(https://images.pexels.com/photos/2668314/pexels-photo-2668314.jpeg)",
      ...
      <section className="bg-white py-12">
        ...
        text-center">
          ...
          <p className="text-gray-700 text-center mb-8">
            Discover beautifully designed cards curated for inspiration and
            creativity. Browse through the gallery to find designs that spark
            your imagination.
          </p>
      ...
      <section className="bg-gradient-to-r from-purple-400 to-purple-950 text-white text-center my-8">
        <div className="container mx-auto py-40">
          ...
          <p className="text-gray-200 text-lg">
            We are passionate about showcasing beautiful card designs. Our
            collection is curated to inspire creativity and provide a platform
            for designers to share their work.
          </p>
          <p className="text-gray-200 text-lg">
            Join us in exploring the world of card designs and discover the
